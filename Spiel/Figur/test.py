...
projektil = pygame.image.load("Spiel/Gegner/PNG/Wraith3/PNG Sequences/Feuerball.png").convert_alpha()
gegner =Gegner(screen, "Fernkampf", 1700, 750, 900, 900, 200, 200, [1,0,0,0], 3, 6, projektil==projektil, angriffAnimation=[
